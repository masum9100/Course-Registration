...
const Home = () => {
    ...
    const [leftCredit, setLeftCredit] = useState(20)
    ...
    function handleSelectCourse(course) {
        ...
        if (selectedCourse.includes(course)) {
            ...
            selectedCourse.forEach((course)=>{
                tPrice = tPrice + course.price
            })
            console.log(tPrice)

            const totalLeftCredit = 20-count

            if (totalLeftCredit < 0) {
                toast.error("You don't have any credit hours left.", {
                    position: toast.POSITION.TOP_CENTER,
                });
                return;
            }
    ...
    return (
        <div className='max-w-screen-xl mx-auto mb-14'>
            ...
            <div className='flex mt-14'>
                ...
                <div className='flex flex-wrap gap-4 '>
                    {
                        allCourses.map(course => (
                            <div key={course.id} className='sm:w-52 md:w-60 lg:w-72 bg-white p-3 rounded-md '>
                ...
                leftCredit={leftCredit} totalCredit={totalCredit} totalPrice={totalPrice}></Cart>
            </div>
            <ToastContainer />
        </div>
    );
